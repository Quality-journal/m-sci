                        ...
                        <tr>
                            ...
                            <td class="flex space-x-4 justify-end text-right py-3 px-4">
                                <a href="{{ route('articles.edit', $article->id)}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-blue-600 h-6 w-6" fill="none"
                                ...
                                <form action="{{ route('articles.destroy', $article->id)}}" method="POST"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" onclick="confirmDelete(event, '{{ $article->id }}')"><svg
                                            xmlns="http://www.w3.org/2000/svg" class="text-red-600 h-6 w-6" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
