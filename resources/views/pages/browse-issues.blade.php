<x-guest-layout>
    ...
    <x-slot name="title">Science of Maintenance | {{ 'Browse issues' }}</x-slot>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg py-5 p-5">
            ...
            <div class="flex flex-wrap py-4">
                ...
                <div class="w-full sm:w-3/4 px-8">
                    <h1 class="text-2xl font-semibold mt-2 pb-4 text-yellow-500">{{ $title }}</h1>
                    <hr>
                        ...
                        <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div class="bg-gray-200 px-4 py-6">
                                <h3 class="title-font font-semibold text-3xl text-gray-900">
                                    <a class="text-center text-yellow-500 hover:text-yellow-700 transition-all" href="/selection/{{ $selection->slug }}"> {{
                                        $selection->title }} </a>
                                </h3>
                            </div>
                        </div>
