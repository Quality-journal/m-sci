        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg py-5 p-5">
            ...
            <div class="flex flex-wrap py-4">
                ...
                <div class="w-full sm:w-3/4 px-8">
                    ...
                    <h2 class="text-xl font-semibold my-2 mb-2">Paper's information</h2>
                    <hr>
                    ...
                    <h2 class="text-xl font-semibold my-2 mb-2">Recognitions</h2>
                    <hr>
                    <div class="ck-content mt-4 mb-5">
                    ...
                    <div class="mt-8">
                        <div @click='toggle = !toggle'
                            class="bg-gray-100 px-4 py-4 cursor-pointer w-full sm:w-1/3 mb-4 sm:mb-0">How to cite this
                            paper <i class="fas fa-chevron-down ml-2"></i></div>

                        <div v-show='toggle' class="bg-gray-100 pl-2 py-4 relative z-10 mb-4 sm:mb-0">
                        ...
                        <div class="w-full sm:w-2/3 float-right mt-3">
                            <div
                                ...
                                <div class="font-bold text-center"><a href="{{ asset('/articles_pdf/'.$article->pdf) }}"
                                        target="_blank"><i class="fas fa-download"></i><br>PDF</a></div>
                            </div>

                            {{-- <div
                                class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-yellow-500 text-white mr-10 mb-10 flex-shrink-0">
                            ...
                            <div
                                class="w-20 h-20 inline-flex items-center justify-center rounded-full bg-yellow-500 text-white mb-10 flex-shrink-0">
                                <div class="text-center">
                                    <span class="font-bold">105</span>
                                    <br><span class="text-xs">Downloads</span>
                                </div>
                            </div>
                        </div> --}}
