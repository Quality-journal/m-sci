<x-guest-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 min-h-screen pb-6 bg-white">
        <div class="text-black bg-white flex items-center justify-center pt-5 ">
            <form id="form" action="{{route('searching')}}" autocomplete="off">
                <div class="border rounded overflow-hidden flex">
                    ...
                    <input id="input" type="text" name="search" class="px-4 py-2 border rounded"
                        placeholder="Search...">

                    <button id="button" class="flex items-center justify-center px-4 border-l">
                        <svg class="h-4 w-4 text-gray-600" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
        ...
        <div class="text-gray-600 bg-white flex-col items-center justify-center mt-5 ">
